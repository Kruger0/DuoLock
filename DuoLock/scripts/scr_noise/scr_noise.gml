...
global.__easynoise_cache		= {};
global.__easynoise_cache.w		= _spr_w;
global.__easynoise_cache.h		= _spr_h;
global.__easynoise_cache.buff	= buffer_create(_spr_w * _spr_h, buffer_fast, 1);
...
for (var _i = 0; _i < _spr_w * _spr_h; _i++) {
    ...
    buffer_poke(global.__easynoise_cache.buff, _i, buffer_u8, _val);
}
...
///@desc Returns a perlin noise value in a 2D coordinate system
///@arg x = the horizontal sample coordinate.
///@arg y = the vertical sample coordinate.
function noise_get(_x, _y = 0) {
    var _data = global.__easynoise_cache;
